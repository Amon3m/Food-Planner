...
public class MealsListAdapter extends RecyclerView.Adapter<MealsListAdapter.ViewHolder> {
    ...
    public MealsListAdapter(ArrayList<FilterMealItem> mealsList, Context context,OnMealClickListener listener) {
...
//            @Override
//            public void onClick(View v) {
//                listener.onAddClick(filterMealItem);
//            }
//        });
//
...
//            @Override
//            public void onClick(View v) {
//                listener.onFavClick(filterMealItem);
//            }
//        });
//        holder.addFav.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//            addMeal=itemView.findViewById(R.id.add_ins_floating);
//
//            addFav=itemView.findViewById(R.id.add_ins_floating);
        }
    }
}
